...
export const getActions = (navigation) => [
  { Icon: Navigation, label: "Navigate", sub: "Find your way", color: "#7128CE", onPress: () => navigation.navigate("Navigation") },
  ...
  { Icon: CalendarDays, label: "Events", sub: "What's on today", color: "#4A8A5A", onPress: () => navigation.navigate("Events") },
];